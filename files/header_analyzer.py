...
_TRUSTED_RELAY_HINTS = (
    "google.com", "gmail.com", "outlook.com", "protection.outlook.com",
    "amazonses.com", "sendgrid.net", "mailgun.org", "mimecast.com",
    "proofpoint.com",
)
...
def find_originating_hop(hops: list[Hop]) -> Optional[Hop]:
    ...
    for hop in hops:
        ...
        if any(hint in host for hint in _TRUSTED_RELAY_HINTS):
            continue
        return hop
